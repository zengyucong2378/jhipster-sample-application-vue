    ...
    if (this.task.id) {
      this.taskService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.task.updated', { param: param.id });
      ...
      this.taskService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.task.created', { param: param.id });
