  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterSampleApplicationVueApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="$t('jhipsterSampleApplicationVueApp.employee.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.firstName')" for="employee-firstName"
              >First Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.lastName')" for="employee-lastName"
              >Last Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.email')" for="employee-email"
              >Email</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.phoneNumber')" for="employee-phoneNumber"
              >Phone Number</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.hireDate')" for="employee-hireDate"
              >Hire Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.salary')" for="employee-salary"
              >Salary</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('jhipsterSampleApplicationVueApp.employee.commissionPct')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.manager')" for="employee-manager"
              >Manager</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.employee.department')" for="employee-department"
              >Department</label
            >
