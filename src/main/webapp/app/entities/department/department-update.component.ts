    ...
    if (this.department.id) {
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.department.updated', { param: param.id });
      ...
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.department.created', { param: param.id });
