    ...
    if (this.country.id) {
      this.countryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.country.updated', { param: param.id });
      ...
      this.countryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.country.created', { param: param.id });
