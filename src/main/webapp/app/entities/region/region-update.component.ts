    ...
    if (this.region.id) {
      this.regionService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.region.updated', { param: param.id });
      ...
      this.regionService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.region.created', { param: param.id });
