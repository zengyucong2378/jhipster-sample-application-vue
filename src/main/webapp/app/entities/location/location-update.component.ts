    ...
    if (this.location.id) {
      this.locationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.location.updated', { param: param.id });
      ...
      this.locationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.location.created', { param: param.id });
