  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterSampleApplicationVueApp.job.home.createOrEditLabel"
          data-cy="JobCreateUpdateHeading"
          v-text="$t('jhipsterSampleApplicationVueApp.job.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.job.jobTitle')" for="job-jobTitle"
              >Job Title</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.job.minSalary')" for="job-minSalary"
              >Min Salary</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.job.maxSalary')" for="job-maxSalary"
              >Max Salary</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label v-text="$t('jhipsterSampleApplicationVueApp.job.task')" for="job-task">Task</label>
            <select
              class="form-control"
              id="job-tasks"
              data-cy="task"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationVueApp.job.employee')" for="job-employee"
              >Employee</label
            >
