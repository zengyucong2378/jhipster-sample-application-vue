    ...
    if (this.job.id) {
      this.jobService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.job.updated', { param: param.id });
      ...
      this.jobService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationVueApp.job.created', { param: param.id });
